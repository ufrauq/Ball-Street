...
The user dashboard will be the main screen for the BallStreet application. The users net worth and their net worth from the last 10 days will be displayed. From this screen, the user will be able to access the <a href="#playerStockMarket">player stock market </a>, their <a href="#userStocks">personal stocks </a>, their <a href="#userProfileSettings">profile settings </a> and their <a href="#tradeRequests">current stock trade requests from other users.</a>  <br><br>
