...
Although there were many drawbacks to our SQL implementation, the SQL design choice was beneficial. This implementaiton for player data gave us many benefits and the ability to implement a few features very easily. One of the features that benefited from the SQL database implementation was searchability of our stock market. SQL allows us to easily execute queries based upon a keyword and efficiently return the results to display on our front-end. This enabled us to implement a seemingly complex feature in a  matter of minutes.<br><br>
